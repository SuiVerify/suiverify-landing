  ...
  const steps = [
    {
      ...
      description: "Upload your Government Proof of Identity for secure verification",
      icon: (
    ...
    },
    {
      ...
      description: "Your KYC documents are encrypted using Seal",
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      description: "Encrypted KYC documents are stored in Walrus",
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      description: "Get your verified digital identity as a DID NFT on Sui",
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
