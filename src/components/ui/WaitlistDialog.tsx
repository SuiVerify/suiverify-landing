    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-primary/40 bg-opacity-50 flex items-center justify-center z-99999 p-4"
          onClick={onClose}
        >
          <motion.div
            ...
            className="bg-[#F8FAFC] rounded-2xl md:p-8 p-6 max-w-md w-full shadow-2xl relative border-[3px] border-primary outfit"
          ...
          >
            ...
            <div className="md:space-y-6 sm:space-y-3">
              ...
              {/* Footer Note */}
              <div className="text-center mt-4 sm:pt-2 md:pt-4 border-t border-primary/40">
